...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'channels',  # ← ДОБАВЬ ЭТУ СТРОКУ
]

MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # ← ДОБАВЬ В НАЧАЛО
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Для домашнего использования
    ],
...
#     "http://192.168.1.100:3000",  # TV в локальной сети
# ]
